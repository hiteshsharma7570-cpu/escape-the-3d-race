    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Glass dashboard */}
          <div className="relative glass-card gold-border rounded-xl sm:rounded-2xl px-1.5 py-1.5 sm:px-6 sm:py-5 max-[359px]:px-1 max-[359px]:py-1 w-[94%] h-full max-w-[90%] sm:max-w-[560px] flex flex-col items-center justify-start gap-1.5">
            ...
            {onRollDice && (
              <div className="mt-auto pt-1 sm:pt-3 pb-1 w-full border-t border-amber-500/20 flex items-center justify-center px-1 sm:px-2">
                <DiceRoll
                  diceValue={diceValue}
                  isRolling={!!isRolling}
