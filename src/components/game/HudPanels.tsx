...
export const PlayerPanel = ({ gameState }: { gameState: GameState }) => {
  ...
  return (
    <div className="glass-card rounded-2xl p-3 w-full sm:w-[260px]">
  ...
  return (
    <div className="flex flex-col items-center gap-3 w-full">
      <div className="flex gap-3 h-16 items-center justify-center">
        <motion.div
          className="w-14 h-14 rounded-xl flex items-center justify-center font-display font-black text-3xl text-slate-900"
          style={{
      ...
      <button
        ...
        className="relative w-full max-w-[260px] rounded-full px-6 py-4 font-display font-bold text-white tracking-widest text-lg disabled:opacity-70 disabled:cursor-not-allowed animate-roll-glow transition-transform hover:scale-105 active:scale-95"
        style={{
      ...
      >
        ROLL DICE
        <div className="text-[10px] font-sans font-normal opacity-80 tracking-normal -mt-0.5">Click to Roll</div>
      </button>
    </div>
  );
};
